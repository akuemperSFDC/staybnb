...
def seed_listings():
    listing1 = Listing(user_id=1, type='House', space='Entire Place', title='Newly Furnished Home', description='Our brand new furnished home, with a walkscore of 98!', country='US', city='Portland', state='OR', address='123 SW Easy Street', price_per_night=150, cleaning_fee=65, check_in_time='3:00 PM', check_in_type='Code',
    wifi=1, air_conditioning=1, heat=1, parking='Private Driveway', bedrooms=4, beds=4, bathrooms=2, sleeps=8)

    listing2 = Listing(user_id=1, type='House', space='Entire Place', title='Beautiful Colonial Style Home', description='Old home, updated, and close to public transit', country='US', city='Eugene', state='OR', address='345 SW Hammond Drive', price_per_night=100, cleaning_fee=40, check_in_time='3:00 PM', check_in_type='Code', wifi=1, air_conditioning=1, heat=1, parking='Private Driveway', bedrooms=2, beds=3, bathrooms=1.5, sleeps=5)
